                                                ...
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            ...
                                                            <span class="caption-subject font-green-sharp bold uppercase">Data Order</span>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <ul class="nav nav-pills">
                                                            <li class="active">
                                                                <a href="#tab_2_1" data-toggle="tab"> Order Baru </a>
                                                            </li>
                                                            <li>
                                                                <a href="#tab_2_2" data-toggle="tab"> Order Diproses </a>
                                                            </li>
                                                                        ...
                                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td> 90 % </td>
                                                                                    <td> Belum </td>
                                                                                    <td> <a href="detail_cetak.php" > <button class="btn blue btn-xs tooltips" data-container="body" data-placement="top" data-original-title="view"><i class="fa fa-eye"></i></button></a> </td>
                                                                                </tr>
                                                                                <tr>
