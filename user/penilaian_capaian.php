            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Penilaian Capaian dan Perilaku</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Penilaian Capaian dan Perilaku</span>
                                    </div>
                                                                    </div>
                                                    ...
                                                    <thead>
                                                                ...
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                 ...
                                                                 elseif ($_SESSION['jabatan']=='J09') {
                                                                    ...
                                                                    $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.status_ajuan ='4' and skp.peg_userid='".$_SESSION['userid']."'  ");
                                                                 }
                                                                 $no = 1;
                                                                 while ($rr = mysqli_fetch_array($sql)) {
                                                                    ...
                                                                    <tr align='left'>
                                                                       ...
                                                                       <?php 
                                                                        ...
                                                                        <td>
                                                                        <a href="lihat_pengajuanskp.php?id=<?php echo $rr['KODE_SKP']; ?>&hal=capaian" > <button class="btn blue btn-xs tooltips" data-container="body" data-placement="top" data-original-title="detail"><i class="fa fa-newspaper-o"></i></button></a>
                                                                        <?php if ($_SESSION['jabatan'] == 'J00') {?>
                                                                        <?php if ($rr['statusnilai'] == 0 || $rr['statusnilai'] == 3) {?>
                                                                        <a href="input_nilaicapaian.php?id=<?php echo $rr['KODE_SKP']; ?>"><button class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Input Nilai"><i class="fa fa-edit"></i></button></a>
                                                                        <?php } else {} ?>
