            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Data Riwayat Pengajuan Keberatan SKP</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Riwayat Pengajuan Keberatan SKP</span>
                                    </div>
                                                                    </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <thead>
                                                                ...
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                        ...
                                                                        WHERE skp.`USERID`=p1.`USERID` and (skp.statusnilai='3' or skp.statusnilai='5' or skp.statusnilai='7' or skp.keberatan > '0')  "); //statuspeg apa ?
                                                                } elseif ($_SESSION['jabatan']=='J00'){
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.peg_userid='".$_SESSION['userid']."' and (skp.statusnilai='3' or skp.statusnilai='5' or skp.statusnilai='7' or skp.keberatan > '0') "); //statuspeg apa ?
                                                                } elseif ($_SESSION['jabatan']=='J09'){
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.peg2_userid='".$_SESSION['userid']."' and (skp.statusnilai='3' or skp.statusnilai='5' or skp.statusnilai='7' or skp.keberatan > '0') "); //statuspeg apa ?
                                                                } else {
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip ,skp.statusnilai
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.userid='".$_SESSION['userid']."' and (skp.statusnilai='3' or skp.statusnilai='5' or skp.statusnilai='7' or skp.keberatan > '0') "); //statuspeg apa ?
                                                                } 
                                                                 $no = 1;
                                                                 while ($rr = mysqli_fetch_array($sql)) {
                                                                    ...
                                                                    <tr align='left'>
                                                                       ...
                                                                       <?php 
                                                                        ...
                                                                        <?php
                                                                         if($rr['statusnilai']==6){
                                                                         echo "<a class='btn btn-circle btn-xs blue' ><i class='icon-user-following'> </i> sudah </a>"; 
                                                                         }
                                                                         else{
                                                                          echo "<a class='btn btn-circle btn-xs red' ><i class='icon-action-redo'> </i> belum </a>";
                                                                         }
                                                                          ?>
                                                                       </td>
                                                                        ...
                                                                        <td>
                                                                        <a href="view_keberatan.php?id=<?php echo $rr['KODE_SKP']; ?>" > <button class="btn blue btn-xs tooltips" data-container="body" data-placement="top" data-original-title="detail"><i class="fa fa-newspaper-o"></i></button></a>
                                                                     <?php if($rr['statusnilai']!=6){ ?>
                                                                        <a href="input_keberatan.php?id=<?php echo $rr['KODE_SKP']; ?>"><button class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Input keberatan"><i class="fa fa-edit"></i></button></a>
                                                                        <?php } else {} ?>
