            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Persetujuan SKP</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Persetujuan SKP</span>
                                    </div>
                                                                    </div>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <thead>
                                                                ...
                                                                $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip,skp.STATUSNILAI
                                                                        ...
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.STATUSNILAI > '0' and skp.`STATUS_AJUAN`='4' "); //statuspeg apa ?
                                                                } elseif ($_SESSION['jabatan']=='J00') {
                                                                    # code...
                                                                     $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip,skp.STATUSNILAI
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.STATUSNILAI > '0' and skp.peg_userid='".$_SESSION['userid']."' and skp.`STATUS_AJUAN`='4'  ");
                                                                } elseif ($_SESSION['jabatan']=='J09') {
                                                                    # code...
                                                                     $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip,skp.STATUSNILAI
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.STATUSNILAI > '0' and skp.peg2_userid='".$_SESSION['userid']."' and skp.`STATUS_AJUAN`='4' ");
                                                                }
                                                                else {
                                                                    $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip,skp.STATUSNILAI
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.STATUSNILAI > '0' and skp.userid='".$_SESSION['userid']."' and skp.`STATUS_AJUAN`='4' ");
                                                                }
                                                                        ...
                                                                        <td><?php echo  $rr['JANGKAWAKTU_PENILAIAN']; ?></td>
                                                                         ...
                                                                         <!-- jika status nilai
                                                                            ...
                                                                            <?php
                                                                             ...
                                                                             if($rr[8]=='2'){
                                                                              echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-primary\"> Di Setujui yang dinilai </span>                                                                </p>";
                                                                             }
                                                                             elseif($rr[8]=='3'){
                                                                              echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-danger\"> Pegawai yang dinilai keberatan </span>                                                                </p>";
                                                                             }
                                                                             elseif($rr[8]=='4'){
                                                                              
                                                                               echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-primary\"> disetujui pejabat penilai </span>                                                                </p>";
                                                                             }
                                                                             elseif($rr[8]=='5'){
                                                                              
                                                                              echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-danger\"> tidak pejabat penilai </span>                                                                </p>";
                                                                             }
                                                                             elseif($rr[8]=='6'){
                                                                              
                                                                               echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-primary\"> disetujui Atasan pejabat penilai </span>                                                                </p>";
                                                                             }
                                                                             elseif($rr[8]=='7'){
                                                                              
                                                                              echo "<p id=\"sample_editable_1_new\" > <span class=\"label label-danger\"> tidak disetujui Atasan pejabat penilai </span>                                                                </p>";
                                                                             }
                                                                             elseif ($rr[8]=='1') {  ?>
                                                                             <p id="sample_editable_1_new" > <span class="label label-success"> Proses </span> </p>
                                                                             <?php } 
                                                                             else { 
                                                                             echo "proses"; } ?>
                                                                           </td>                                                                    
