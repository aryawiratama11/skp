            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Data Riwayat Pangkat</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Riwayat Pangkat</span>
                                    </div>
                                                                    </div>
                                <div class="portlet-body">
                                    <ul class="nav nav-pills">
                                        <li class="active">
                                            <a href="#tab_2_1" data-toggle="tab"> Data Riwayat Pangkat </a>
                                        </li>
                                        <li>
                                            <a href="#tab_2_2" data-toggle="tab"> Tambah Riwayat Pangkat </a>
                                        </li>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <thead>
                                                                ...
                                                                $sql = mysqli_query($con," SELECT p.nip, p.`NAMA_PEGAWAI` , pa.`NAMA_PANGKAT` , pa.`GOLONGAN_RUANG` ,p.userid,hp.statuspangkat, hp.id_h_pangkat
                                                                    ...
                                                                    WHERE p.`USERID`=hp.userid AND hp.`ID_PANGKAT`=pa.`ID_PANGKAT` "); //statuspeg apa ?
                                                                } else {
                                                                $sql = mysqli_query($con," SELECT p.nip, p.`NAMA_PEGAWAI` , pa.`NAMA_PANGKAT` , pa.`GOLONGAN_RUANG` ,p.userid,hp.statuspangkat, hp.id_h_pangkat
                                                                    FROM pegawai p , HISTORY_PANGKAT hp , PANGKAT pa 
                                                                    WHERE p.`USERID`=hp.userid AND hp.`ID_PANGKAT`=pa.`ID_PANGKAT` and p.userid='".$_SESSION['userid']."' ");
                                                                    }
                                                                 $no = 1;
                                                                 while ($rr = mysqli_fetch_array($sql)) {
                                                                    ...
                                                                    <tr align='left'>
                                                                       ...
                                                                       <td>
                                                                        ...
                                                                        <td><a href="edit.php?id=<?php echo $rr['id_h_pangkat']; ?>&hal=pangkat"><button class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Update"><i class="fa fa-edit"></i></button></a>
                                                                        <!-- <a href="aksi/hapus_rw.php?id=<?php //echo $rr['id_h_pangkat']; ?>&hal=pendidikan" class="delete-link"> <button class="btn red btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Hapus"><i class="fa fa-remove"></i></button></a> -->
                                                                        </td>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Tambah Riwayat pangkat</span>
                                    </div>
