            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Data Keberatan Penilaian</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Tambah Keberatan Penilaian</span>
                                    </div>
                                    ...
                                    <form action="aksi/insert_keberatan.php?id=<?php echo $_GET['id'] ?>" class="form-horizontal" enctype="multipart/form-data" method="POST">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Keberatan
                                                    <span class="required" aria-required="true">*</span>
                                                </label>
                                                <div class="col-md-10">
                                                   <textarea  name="summernote" id="summernote_1" required> </textarea>
