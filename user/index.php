                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <thead>
                                                                ...
                                                                if ($_SESSION['jabatan']=='J03') {
                                                                    ...
                                                                    $sql = mysqli_query($con," SELECT skp.`USERID` , skp.`PEG_USERID` ,skp.`PEG2_USERID` , skp.`JANGKAWAKTU_PENILAIAN` , skp.`STATUS_AJUAN` , skp.`KODE_SKP`, p1.NAMA_PEGAWAI ,p1.nip
                                                                        FROM sasaran_kinerja_pegawai skp , pegawai p1 
                                                                        WHERE skp.`USERID`=p1.`USERID` and skp.userid='".$_SESSION['userid']."' ");
                                                                }
                                                                //statuspeg apa ?
                                                                 $no = 1;
                                                                 while ($rr = mysqli_fetch_array($sql)) {
                                                                    ...
                                                                    <tr align='left'>
                                                                       ...
                                                                       <?php 
                                                                        ...
                                                                        <td><?php echo  $rr['JANGKAWAKTU_PENILAIAN']; ?></td>
                                                                         <td>
                                                                            <?php
                                                                             ...
                                                                             elseif($rr[4]=='2'){
                                                                              echo "Di Setujui <br> Pejabat Penilai";
                                                                             }
                                                                             elseif($rr[4]=='4'){
                                                                              echo "disetujui atasan <br> pejabat penilai";
                                                                             }
                                                                             elseif ($rr[4]=='3') { ?>
                                                                             <a href="#" class="btn red"> Revisi Penilai </a>
                                                                             <?php }
                                                                             elseif ($rr[4]=='5') { ?>
                                                                             <a href="#" class="btn red"> Revisi Atasan</a>
                                                                             <?php }
                                                                             elseif ($rr[4]=='6') { ?>
                                                                             <a href="#" class="btn green"> Revisi Penilai Sudah</a>
                                                                             <?php }
                                                                             elseif ($rr[4]=='7') { ?>
                                                                             <a href="#" class="btn blue"> Revisi Atasan Sudah</a>
                                                                             <?php } else { 
                                                                             echo "proses"; } ?>
                                                                           </td>                                                                    
                                                                        ...
                                                                        <?php if ($rr['STATUS_AJUAN'] == 0 || $rr['STATUS_AJUAN'] == 3 || $rr['STATUS_AJUAN'] == 5) {?>
                                                                        <a href="detail_rw_pengajuanskp.php?id=<?php echo $rr['KODE_SKP']; ?>"><button class="btn green btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Update"><i class="fa fa-edit"></i></button></a>
                                                                       
                                                                        <?php } elseif ($rr['STATUS_AJUAN'] == 0) {?>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Tambah Riwayat Sasaran Kinerja Pegawai</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="aksi/insert_skp.php" class="form-horizontal" enctype="multipart/form-data" method="POST">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    $query = "SELECT p.`NIP` , p.`NAMA_PEGAWAI` ,p.userid 
                                                    FROM pegawai p , riwayat_jabatan rw  
                                                    WHERE p.`USERID` = rw.`USERID` AND rw.`STATUSJABATAN`='1' AND rw.`ID_JABATAN`='J00' ";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    $query = "SELECT p.`NIP` , p.`NAMA_PEGAWAI` ,p.userid 
                                                    FROM pegawai p , riwayat_jabatan rw  
                                                    WHERE p.`USERID` = rw.`USERID` AND rw.`STATUSJABATAN`='1' AND rw.`ID_JABATAN`='J09' ";
                                                    $hasil = mysqli_query($con, $query);
                                                    while ($row = mysqli_fetch_array($hasil)) {
                                                        ?>
                                                        <option value="<?php echo $row[2] ?>"><?php echo $row[0]." | " .$row[1];?></option>
                                             ...
                                             <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control" placeholder="" name="periode" value="<?php echo date('Y') ?>">
